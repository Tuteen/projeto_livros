...
class TelaLogin(QWidget):
    ...
    def initUI(self):
        ...
        # Connect the returnPressed signal to check_password method
        ...
        botao_login.clicked.connect(self.check_password)
        ...
        try:
            ...
            if user_data:
                ...
                if hashlib.sha256(senha.encode()).hexdigest() == stored_password:
                    ...
                    conn.close()
                    self.controller.show_principal(nome_completo, usuario, is_admin=(nivel_acesso == 'admin'))
                else:
                    conn.close()
