...
from PySide6.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout, QListWidget, QListWidgetItem, QLabel, QPushButton, QLineEdit, QMessageBox, QComboBox)
...
class TelaListarLivros(QWidget):
    ...
    def initUI(self):
        ...
        self.book_type_filter.addItems([
            'Todos', 'NASCIMENTO (LIVRO A)', 'CASAMENTO CIVIL (LIVRO B)', 'CAS. REL. CIVIL (LIVRO BA)', 
        ...
        # Lists for books, folhas, and termos
    ...
    def carregar_livros(self):
        ...
        WHERE Livros.tipo LIKE %s AND Livros.numero LIKE %s
        GROUP BY Livros.id
        ...
        """
        cursor.execute(query, (tipo_livro, numero_livro))
